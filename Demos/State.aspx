    ...
    <div>
     <table class="auto-style1">
            <tr>
                ...
                <td>
                    <asp:Button ID="SetDate" runat="server" Text="SetDate" OnClick="SetDate_Click" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Button ID="PlainPostback" runat="server" Text="Plain Postback" EnableViewState="False" />
                </td>
            </tr>
            <tr>
                <td>
